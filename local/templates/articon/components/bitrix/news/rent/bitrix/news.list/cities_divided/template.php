        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <?if (!empty($arResult['CITY_ITEMS'])):?>
                        <?foreach ($arResult['CITY_ITEMS'] as $city => $items):?>
                            <div class="rent-items-block">
                                <h2 class="rent-items-block__heading"><?=$city?></h2>
                                <div class="rent-items">
                                    <div class="row">
                                        <?foreach ($items as $i => $arItem):?>
                                            <div class="col-12 col-lg-6 order-<?=$i?> order-lg-<?=$i?>">
                                                                    ...
                                                                    <div class="rent-item-price-t-items">
                                                                        <div class="rent-item-price-t-item">
                                                                            <div class="rent-item-price-t-item-col rent-item-price-t-item-col--day">
                                                                                <?=GetMessage('NEWS_RENT_NEWS_LIST_CITIES_DIVIDED_PRICE_TABLE_WEEKDAY')?>
                                                                            </div>
                                                                        ...
                                                                        <div class="rent-item-price-t-item">
                                                                            <div class="rent-item-price-t-item-col rent-item-price-t-item-col--day">
                                                                                <?=GetMessage('NEWS_RENT_NEWS_LIST_CITIES_DIVIDED_PRICE_TABLE_WEEKEND')?>
                                                                            </div>
                                                                            <div class="rent-item-price-t-item-col rent-item-price-t-item-col--price">
                                                        ...
                                                        <div class="rent-item-right">
                                                            ...
                                                            <div class="rent-item-more-link-block">
                                                                <a class="more-link" href="<?=$arItem['DETAIL_PAGE_URL']?>">
                                                                    <?=GetMessage('NEWS_RENT_NEWS_LIST_CITIES_DIVIDED_DETAIL_LINK')?>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
